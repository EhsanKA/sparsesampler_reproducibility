...
address_adata_ref = os.path.join(file_path_env,'mcc_05', "adata.h5ad")
...
address_adata = os.path.join(file_path_env,'mcc_05', "adata_clean.h5ad")
...
address_adata_ref = os.path.join(file_path_env,'mcc_05', "adata_clean.h5ad")
adata = sc.read_h5ad(address_adata_ref)
...
# Randomly sample fewer than 15,000 cells from the osteoblasts group
sampled_idx = np.random.choice(osteoblasts_idx, size=15000, replace=False)
