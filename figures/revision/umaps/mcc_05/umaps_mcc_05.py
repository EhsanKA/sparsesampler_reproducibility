...
"""
Generate UMAP visualizations comparing different sampling methods in MCC_05 reference dataset.
...
class UMAPVisualizer:
    ...
    def __init__(self, data_path: str, directory: str = "mcc_05/benchmark", test_mode: bool = False, figures_dir: str = None):
    ...
    def identify_rare_cell_types(self, adata: sc.AnnData) -> sc.AnnData:
        ...
        # Identify rare cell types using distance and frequency (5/1000 = 0.5% for mcc_05)
    ...
    def generate_individual_umap(self, adata: sc.AnnData, method: str):
        """Generate UMAP plot for Figure 1 (MCC_05) with three square panels (sps, rare, random)."""
        filename = 'test_figure1_mcc_05_sampling_comparison.jpg' if self.test_mode else 'figure1_mcc_05_sampling_comparison.jpg'
    ...
    def generate_combined_umaps(self, adata: sc.AnnData, method: str):
        ...
        filename = 'test_supp_figure2_mcc_05_sampling_analysis.jpg' if self.test_mode else 'supp_figure2_mcc_05_sampling_analysis.jpg'
        output_file = os.path.join(self.figures_dir, filename)
        os.makedirs(os.path.dirname(output_file), exist_ok=True)
    ...
    def generate_label_umap(self, adata: sc.AnnData):
        ...
        filename = 'test_supp_figure1_mcc_05_cell_types.jpg' if self.test_mode else 'supp_figure1_mcc_05_cell_types.jpg'
        output_file = os.path.join(self.figures_dir, filename)
        os.makedirs(os.path.dirname(output_file), exist_ok=True)
...
def main():
    parser = argparse.ArgumentParser(description='Generate UMAP visualizations for MCC_05 data')
