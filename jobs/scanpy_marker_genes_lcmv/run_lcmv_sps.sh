#!/bin/bash
#SBATCH --job-name=scanpy_marker_lcmv_sps
...
#SBATCH --output=/fast/AG_Ohler/ekarimi/projects/sparsesampler_reproducibility/logs/scanpy_marker_lcmv_sps_%j.out
#SBATCH --error=/fast/AG_Ohler/ekarimi/projects/sparsesampler_reproducibility/logs/scanpy_marker_lcmv_sps_%j.err
...
# Run the pipeline
echo "Starting Scanpy marker gene analysis (LCMV) for sps..."
