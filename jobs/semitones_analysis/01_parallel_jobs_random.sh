...
# Using random method for SEMITONES reference cells
# Using 100k samples for SEMITONES reference cells
# DATASETS=('mcc_01' 'mcc_05' 'lcmv')
DATASETS=('mcc')
METHODS=('random')  # Only random method
...
#SBATCH -J semitones_random
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=${CLUSTER_EMAIL}
#SBATCH -o ${LOG_PATH}/semitones_analysis/logs/output_random_%A_%a.stdlog
#SBATCH -e ${LOG_PATH}/semitones_analysis/logs/output_random_%A_%a.stderr
#SBATCH -t 24:00:00
#SBATCH --mem=150G
#SBATCH -A ohler
#SBATCH -p normal
...
if [ "\$dataset" == "mcc_01" ] || [ "\$dataset" == "mcc_05" ] || [ "\$dataset" == "mcc" ]; then
    ref=30
