...
#SBATCH -J scsampler_array_job_python
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=${CLUSTER_EMAIL}
#SBATCH -o ${LOG_PATH}/mcc_05_production/logs/output_scsampler_%A_%a.stdlog
#SBATCH -t 28:00:00
#SBATCH --mem=200G
#SBATCH -A ohler
#SBATCH -p long
...
file_path="${DATA_PATH}/mcc_05/benchmark/\$ref/\$method/\$size/\$rep/results.pkl"
