...
#$ -N scsampler_array_job_python
#$ -m beas
#$ -M ${CLUSTER_EMAIL}
#$ -o ${LOG_PATH}/mcc_production/logs/output_scsampler_SGE_TASK_ID.stdlog
#$ -j y
#$ -l h_rt=28:00:00
#$ -l m_mem_free=200G
...
file_path="${DATA_PATH}/mcc/benchmark/\$ref/\$method/\$size/\$rep/results.pkl"
